...
# MMacNeil,11.14.2021,Added code to complete assignment 5
# MMacNeil,11.17.2021,Updated code to implement ideas provided by the QA Review like the Boolean Flag technique
# ------------------------------------------------------------------------ #
...
while (True):
    ...
    # Step 4 - Add a new item to the list/Table
        ...
        for row in lstTable:
            ...
            strPriority = input('What priority level is it? ')
            lstTable.append({'Task': strTask, 'Priority': strPriority})
            break
        continue
    # Step 5 - Remove a new item from the list/Table
    elif (strChoice.strip() == '3'):
        strKeyToRemove = input("Remove which task? ")
        ...
        if(blnItemRemoved == True):
            ...
            print(strKeyToRemove, "isn't in the table list.")
        continue
